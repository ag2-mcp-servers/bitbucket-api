...
from models import (
    ...
    Report,
    ReportAnnotation,
    RepositoriesWorkspaceRepoSlugCommitCommitReportsReportIdAnnotationsPostRequest,
    RepositoriesWorkspaceRepoSlugCommitCommitReportsReportIdAnnotationsPostResponse,
    Repository,
...
app = MCPProxy(
    ...
    title='Bitbucket API',
    version='2.0',
    servers=[{'url': 'https://api.bitbucket.org/2.0'}],
)
...
def get_addon_linkers__linker_key(linker_key: str):
    """
...
def delete_addon_linkers__linker_key_values(linker_key: str):
    """
...
def get_addon_linkers__linker_key_values(linker_key: str):
    """
...
def post_addon_linkers__linker_key_values(linker_key: str):
    """
...
def put_addon_linkers__linker_key_values(linker_key: str):
    """
...
of the authenticated application. """,
    tags=['addon_management', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def delete_addon_linkers__linker_key_values__value_id(
    linker_key: str, value_id: int = ...
):
    """
...
of the authenticated application. """,
    tags=['addon_management', 'repository_hosted_properties_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_addon_linkers__linker_key_values__value_id(
    linker_key: str, value_id: int = ...
):
    """
    Get a linker value
...
``` """,
    tags=['webhook_handling', 'workspace_webhook_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_hook_events__subject_type(subject_type: SubjectType):
    """
...
[filtering and sorting](/cloud/bitbucket/rest/intro/#filtering) for more details. """,
    tags=['repository_pull_request_handling', 'pull_request_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_pullrequests__selected_user(
    state: Optional[State4] = None, selected_user: str = ...
):
    """
...
This endpoint also supports filtering and sorting of the results. See
[filtering and sorting](/cloud/bitbucket/rest/intro/#filtering) for more details. """,
    tags=['repository_management', 'workspace_operation_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace(
    role: Optional[Role1] = None,
    q: Optional[str] = None,
    sort: Optional[str] = None,
    workspace: str = ...,
...
def delete_repositories__workspace__repo_slug(
    redirect_to: Optional[str] = None, repo_slug: str = ..., workspace: str = ...
):
    """
    Delete a repository
    """
...
def get_repositories__workspace__repo_slug(repo_slug: str, workspace: str = ...):
    """
    Get a repository
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def post_repositories__workspace__repo_slug(
    repo_slug: str, workspace: str = ..., body: Repository = None
):
    """
    Create a repository
    """
...
def put_repositories__workspace__repo_slug(
    repo_slug: str, workspace: str = ..., body: Repository = None
):
    """
    Update a repository
...
repository. """,
    tags=['branch_restriction_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_branch_restrictions(
...
def post_repositories__workspace__repo_slug_branch_restrictions(
    repo_slug: str, workspace: str = ..., body: Branchrestriction = ...
):
    """
...
def delete_branch_restriction_rule(id: str, repo_slug: str = ..., workspace: str = ...):
    """
...
def get_repositories__workspace__repo_slug_branch_restrictions__id(
    id: str, repo_slug: str = ..., workspace: str = ...
):
    """
...
def put_repositories__workspace__repo_slug_branch_restrictions__id(
    id: str, repo_slug: str = ..., workspace: str = ..., body: Branchrestriction = ...
):
    """
...
``` """,
    tags=['repository_branching_model_fetching'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_branching_model(
    repo_slug: str, workspace: str = ...
):
    """
...
``` """,
    tags=['repository_branching_model_fetching', 'project_branching_model_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_branching_model_settings(
    repo_slug: str, workspace: str = ...
):
    """
...
We have deprecated this side effect and will remove it on 1 August 2022. """,
    tags=[
        ...
        'branch_restriction_handling',
        'project_branching_model_handling',
    ],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
...
def put_repositories__workspace__repo_slug_branching_model_settings(
    repo_slug: str, workspace: str = ...
):
    """
...
``` """,
    tags=['commit_retrieval', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_commit__commit(
    commit: str, repo_slug: str = ..., workspace: str = ...
):
    """
    Get a commit
    """
...
commits. """,
    tags=['commit_approval_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def delete_repositories__workspace__repo_slug_commit__commit_approve(
    commit: str, repo_slug: str = ..., workspace: str = ...
):
    """
    Unapprove a commit
...
def post_repositories__workspace__repo_slug_commit__commit_approve(
    commit: str, repo_slug: str = ..., workspace: str = ...
):
    """
    Approve a commit
...
the `sort` query parameter. """,
    tags=['commit_comments_handling', 'commit_retrieval'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_commit__commit_comments(
    q: Optional[str] = None,
    sort: Optional[str] = None,
    commit: str = ...,
    repo_slug: str = ...,
...
$ curl https://api.bitbucket.org/2.0/repositories/atlassian/prlinks/commit/db9ba1e031d07a02603eae0e559a7adc010257fc/comments/ \
  ...
  -d '{"content": {"raw": "One more thing!"},
       "parent": {"id": 5728901}}'
``` """,
    tags=['commit_comments_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def post_repositories__workspace__repo_slug_commit__commit_comments(
    commit: str, repo_slug: str = ..., workspace: str = ..., body: CommitComment = ...
):
    """
...
def delete_commit_comment(
    comment_id: int, commit: str = ..., repo_slug: str = ..., workspace: str = ...
):
    """
...
@app.delete(
    ...
    tags=['commit_properties_handling', 'repository_management'],
)
def delete_commit_hosted_property_value(
    workspace: str,
    repo_slug: str = ...,
    commit: str = ...,
    app_key: str = ...,
...
def get_commit_hosted_property_value(
    workspace: str,
    repo_slug: str = ...,
    commit: str = ...,
    app_key: str = ...,
...
def update_commit_hosted_property_value(
    workspace: str,
    repo_slug: str = ...,
    commit: str = ...,
    app_key: str = ...,
...
@app.get(
    ...
    tags=['repository_pull_request_handling', 'pull_request_change_listing'],
)
def get_pullrequests_for_commit(
    workspace: str,
    repo_slug: str = ...,
    commit: str = ...,
    page: Optional[int] = 1,
    pagelen: Optional[int] = 30,
):
    """
...
@app.get(
    ...
    tags=['commit_report_handling', 'workspace_operation_handling'],
)
def get_reports_for_commit(workspace: str, repo_slug: str = ..., commit: str = ...):
    """
    List reports
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
Please refer to the [Code Insights documentation](https://confluence.atlassian.com/bitbucket/code-insights-994316785.html) for more information.
 """,
    tags=['commit_report_handling', 'repository_management'],
)
...
@app.get(
    ...
    tags=['commit_annotation_handling'],
)
def get_annotations_for_report(
    workspace: str,
    repo_slug: str = ...,
    commit: str = ...,
    report_id: str = Path(..., alias='reportId'),
...
Please refer to the [Code Insights documentation](https://confluence.atlassian.com/bitbucket/code-insights-994316785.html) for more information.
 """,
    tags=['commit_annotation_handling', 'commit_report_handling'],
)
def bulk_create_or_update_annotations(
    ...
    commit: str = ...,
    report_id: str = Path(..., alias='reportId'),
    body: RepositoriesWorkspaceRepoSlugCommitCommitReportsReportIdAnnotationsPostRequest = ...,
):
    """
...
def delete_annotation(
    ...
    commit: str = ...,
    report_id: str = Path(..., alias='reportId'),
    annotation_id: str = Path(..., alias='annotationId'),
):
    """
...
def get_repositories__workspace__repo_slug_commit__commit_statuses(
    q: Optional[str] = None,
    sort: Optional[str] = None,
    commit: str = ...,
    repo_slug: str = ...,
...
def create_commit_build_status(
    commit: str, repo_slug: str = ..., workspace: str = ..., body: Commitstatus = None
):
    """
...
def get_commit_build_status(
    commit: str, key: str = ..., repo_slug: str = ..., workspace: str = ...
):
    """
...
query string, clients can use a `x-www-form-urlencoded` POST instead. """,
    tags=['repository_management', 'commit_retrieval'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_commits(
    repo_slug: str, workspace: str = ...
):
    """
    List commits
...
def post_repositories__workspace__repo_slug_commits(
    repo_slug: str, workspace: str = ...
):
    """
...
def get_repositories__workspace__repo_slug_commits__revision(
    repo_slug: str, revision: str = ..., workspace: str = ...
):
    """
...
def post_repositories__workspace__repo_slug_commits__revision(
    repo_slug: str, revision: str = ..., workspace: str = ...
):
    """
...
tracker enabled. """,
    tags=[
        'repository_component_handling',
        'workspace_project_handling',
        'workspace_operation_handling',
    ],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
...
def get_repositories__workspace__repo_slug_components(
    repo_slug: str, workspace: str = ...
):
    """
    List components
...
@app.get(
    ...
    tags=['repository_component_handling', 'issue_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_components__component_id(
    component_id: int, repo_slug: str = ..., workspace: str = ...
):
    """
...
[effective-default-reveiwers](#api-repositories-workspace-repo-slug-effective-default-reviewers-get) endpoint. """,
    tags=['default_reviewer_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_default_reviewers(
    repo_slug: str, workspace: str = ...
):
    """
...
@app.delete(
    ...
    tags=['default_reviewer_management', 'user_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def remove_default_reviewer_from_repo(
    repo_slug: str, target_username: str = ..., workspace: str = ...
):
    """
...
a default reviewer. """,
    tags=['default_reviewer_management', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def add_user_to_default_reviewers(
    repo_slug: str, target_username: str = ..., workspace: str = ...
):
    """
...
def get_repositories__workspace__repo_slug_deploy_keys(
    repo_slug: str, workspace: str = ...
):
    """
...
``` """,
    tags=['deploy_key_handling', 'project_deploy_key_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def post_repositories__workspace__repo_slug_deploy_keys(
    repo_slug: str, workspace: str = ...
):
    """
...
``` """,
    tags=['deploy_key_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def delete_repositories__workspace__repo_slug_deploy_keys__key_id(
    key_id: str, repo_slug: str = ..., workspace: str = ...
):
    """
...
def get_repositories__workspace__repo_slug_deploy_keys__key_id(
    key_id: str, repo_slug: str = ..., workspace: str = ...
):
    """
...
def put_repositories__workspace__repo_slug_deploy_keys__key_id(
    key_id: str, repo_slug: str = ..., workspace: str = ...
):
    """
...
@app.get(
    ...
    tags=['deployment_handling', 'repository_management'],
)
def get_deployments_for_repository(workspace: str, repo_slug: str = ...):
    """
    List deployments
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def get_deployment_for_repository(
    workspace: str, repo_slug: str = ..., deployment_uuid: str = ...
):
    """
    Get a deployment
    """
...
@app.get(
    ...
    tags=['environment_handling', 'workspace_operation_handling'],
)
def get_deployment_variables(
    workspace: str, repo_slug: str = ..., environment_uuid: str = ...
):
    """
...
@app.post(
    ...
    tags=['deployment_handling', 'environment_handling'],
)
...
@app.delete(
    ...
    tags=['environment_handling', 'deployment_handling'],
)
...
def get_repositories__workspace__repo_slug_diff__spec(
...
def get_repositories__workspace__repo_slug_diffstat__spec(
    ignore_whitespace: Optional[bool] = None,
    merge: Optional[bool] = None,
    path: Optional[str] = None,
    renames: Optional[bool] = None,
...
@app.get(
    ...
    tags=['artifact_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_downloads(
    repo_slug: str, workspace: str = ...
):
    """
...
def post_repositories__workspace__repo_slug_downloads(
    repo_slug: str, workspace: str = ...
):
    """
...
def delete_repositories__workspace__repo_slug_downloads__filename(
    filename: str, repo_slug: str = ..., workspace: str = ...
):
    """
...
def get_repositories__workspace__repo_slug_downloads__filename(
    filename: str, repo_slug: str = ..., workspace: str = ...
):
    """
...
def get_repositories__workspace__repo_slug_effective_branching_model(
    repo_slug: str, workspace: str = ...
):
    """
...
def list_effective_default_reviewers(repo_slug: str, workspace: str = ...):
    """
...
def get_environments_for_repository(workspace: str, repo_slug: str = ...):
    """
    List environments
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def create_environment(
    workspace: str, repo_slug: str = ..., body: DeploymentEnvironment = ...
):
    """
...
def delete_environment_for_repository(
    workspace: str, repo_slug: str = ..., environment_uuid: str = ...
):
    """
...
@app.get(
    ...
    tags=['environment_handling'],
)
def get_environment_for_repository(
    workspace: str, repo_slug: str = ..., environment_uuid: str = ...
):
    """
    Get an environment
...
def update_environment_for_repository(
    workspace: str, repo_slug: str = ..., environment_uuid: str = ...
):
    """
...
def get_repositories__workspace__repo_slug_filehistory__commit__path(
...
repository. """,
    tags=['repository_fork_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_forks(
    role: Optional[Role1] = None,
    q: Optional[str] = None,
    sort: Optional[str] = None,
    repo_slug: str = ...,
...
def post_repositories__workspace__repo_slug_forks(
    repo_slug: str, workspace: str = ..., body: Repository = None
):
    """
    Fork a repository
...
@app.get(
    ...
    tags=['webhook_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_hooks(repo_slug: str, workspace: str = ...):
    """
...
def post_repositories__workspace__repo_slug_hooks(repo_slug: str, workspace: str = ...):
    """
...
def delete_repositories__workspace__repo_slug_hooks__uid(
    repo_slug: str, uid: str = ..., workspace: str = ...
):
    """
...
def get_repositories__workspace__repo_slug_hooks__uid(
    repo_slug: str, uid: str = ..., workspace: str = ...
):
    """
...
def put_repositories__workspace__repo_slug_hooks__uid(
    repo_slug: str, uid: str = ..., workspace: str = ...
):
    """
...
def get_repositories__workspace__repo_slug_issues(repo_slug: str, workspace: str = ...):
    """
    List issues
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def post_repositories__workspace__repo_slug_issues(
    repo_slug: str, workspace: str = ..., body: Issue = ...
):
    """
    Create an issue
    """
...
'Location' response header. This url is the endpoint for where the user can obtain their zip files." """,
    tags=['issue_export_import_handling', 'issue_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def post_repositories__workspace__repo_slug_issues_export(
    repo_slug: str, workspace: str = ..., body: ExportOptions = None
):
    """
    Export issues
    """
...
def check_issue_export_status(
    repo_name: str, repo_slug: str = ..., task_id: str = ..., workspace: str = ...
):
    """
...
def get_repositories__workspace__repo_slug_issues_import(
    repo_slug: str, workspace: str = ...
):
    """
...
``` """,
    tags=['issue_export_import_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def post_repositories__workspace__repo_slug_issues_import(
    repo_slug: str, workspace: str = ...
):
    """
    Import issues
...
def delete_repositories__workspace__repo_slug_issues__issue_id(
    issue_id: str, repo_slug: str = ..., workspace: str = ...
):
    """
    Delete an issue
    """
...
def get_repositories__workspace__repo_slug_issues__issue_id(
    issue_id: str, repo_slug: str = ..., workspace: str = ...
):
    """
    Get an issue
...
def put_repositories__workspace__repo_slug_issues__issue_id(
    issue_id: str, repo_slug: str = ..., workspace: str = ...
):
    """
    Update an issue
...
The files are always ordered by their upload date. """,
    tags=['issue_handling', 'issue_attachment_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def list_issue_attachments(issue_id: str, repo_slug: str = ..., workspace: str = ...):
    """
...
then the existing file will be replaced. """,
    tags=['issue_attachment_handling', 'issue_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def upload_issue_attachment(issue_id: str, repo_slug: str = ..., workspace: str = ...):
    """
...
def delete_issue_attachment(
    issue_id: str, path: str = ..., repo_slug: str = ..., workspace: str = ...
):
    """
...
future. Use `changes.assignee_account_id` instead. """,
    tags=['issue_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_issues__issue_id_changes(
    q: Optional[str] = None,
    sort: Optional[str] = None,
    issue_id: str = ...,
    repo_slug: str = ...,
...
def post_repositories__workspace__repo_slug_issues__issue_id_changes(
    issue_id: str, repo_slug: str = ..., workspace: str = ..., body: IssueChange = ...
):
    """
...
def get_issue_change_object(
    change_id: str, issue_id: str = ..., repo_slug: str = ..., workspace: str = ...
):
    """
...
def get_repositories__workspace__repo_slug_issues__issue_id_comments(
    q: Optional[str] = None,
    issue_id: str = ...,
    repo_slug: str = ...,
    workspace: str = ...,
...
def create_issue_comment(
    issue_id: str, repo_slug: str = ..., workspace: str = ..., body: IssueComment = ...
):
    """
...
def delete_issue_comment(
    comment_id: int, issue_id: str = ..., repo_slug: str = ..., workspace: str = ...
):
    """
...
@app.delete(
    ...
    tags=['issue_handling', 'issue_vote_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def delete_repositories__workspace__repo_slug_issues__issue_id_vote(
    issue_id: str, repo_slug: str = ..., workspace: str = ...
):
    """
...
implies they haven't. """,
    tags=['issue_vote_management', 'issue_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_issues__issue_id_vote(
    issue_id: str, repo_slug: str = ..., workspace: str = ...
):
    """
...
def put_repositories__workspace__repo_slug_issues__issue_id_vote(
    issue_id: str, repo_slug: str = ..., workspace: str = ...
):
    """
    Vote for an issue
...
@app.delete(
    ...
    tags=['issue_handling', 'issue_watching_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def delete_repositories__workspace__repo_slug_issues__issue_id_watch(
    issue_id: str, repo_slug: str = ..., workspace: str = ...
):
    """
...
issue. """,
    tags=['issue_vote_management', 'issue_watching_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_issues__issue_id_watch(
    issue_id: str, repo_slug: str = ..., workspace: str = ...
):
    """
...
indicates that the operation was successful. """,
    tags=['issue_handling', 'issue_vote_management', 'issue_watching_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def put_repositories__workspace__repo_slug_issues__issue_id_watch(
    issue_id: str, repo_slug: str = ..., workspace: str = ...
):
    """
    Watch an issue
...
unspecified which will be returned. """,
    tags=['repository_management', 'repository_merge_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_merge_base__revspec(
    repo_slug: str, revspec: str = ..., workspace: str = ...
):
    """
...
This resource is only available on repositories that have the issue
tracker enabled. """,
    tags=['milestone_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_milestones(
    repo_slug: str, workspace: str = ...
):
    """
    List milestones
...
def get_repositories__workspace__repo_slug_milestones__milestone_id(
    milestone_id: int, repo_slug: str = ..., workspace: str = ...
):
    """
    Get a milestone
    """
...
@app.get(
    ...
    tags=['repository_settings_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_override_settings(
    repo_slug: str, workspace: str = ...
):
    """
...
def put_repositories__workspace__repo_slug_override_settings(
    repo_slug: str, workspace: str = ...
):
    """
...
repository use. It is not decoded into unicode. As such, the
content-type is `text/plain`. """,
    tags=['repository_diff_handling', 'commit_retrieval'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_patch__spec(
    repo_slug: str, spec: str = ..., workspace: str = ...
):
    """
...
``` """,
    tags=['group_permission_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_permissions_config_groups(
    repo_slug: str, workspace: str = ...
):
    """
...
def delete_group_permission_for_repo(
    group_slug: str, repo_slug: str = ..., workspace: str = ...
):
    """
...
def update_group_permission_for_repo(
    group_slug: str, repo_slug: str = ..., workspace: str = ...
):
    """
...
``` """,
    tags=['user_permission_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_permissions_config_users(
    repo_slug: str, workspace: str = ...
):
    """
...
def delete_user_permission_from_repository(
    repo_slug: str, selected_user_id: str = ..., workspace: str = ...
):
    """
...
def update_repo_user_permission(
    repo_slug: str, selected_user_id: str = ..., workspace: str = ...
):
    """
...
@app.delete(
    ...
    tags=['pipeline_cache_handling'],
)
def delete_repository_pipeline_caches(
    workspace: str, repo_slug: str = ..., name: str = ...
):
    """
    Delete caches
    """
...
@app.get(
    ...
    tags=['workspace_operation_handling', 'pipeline_cache_handling'],
)
def get_repository_pipeline_caches(workspace: str, repo_slug: str = ...):
    """
    List caches
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def delete_repository_pipeline_cache(
    workspace: str, repo_slug: str = ..., cache_uuid: str = ...
):
    """
    Delete a cache
    """
...
@app.get(
    ...
    tags=['pipeline_cache_handling', 'workspace_operation_handling'],
)
def get_repository_pipeline_cache_content_u_r_i(
    workspace: str, repo_slug: str = ..., cache_uuid: str = ...
):
    """
...
@app.get(
    ...
    tags=['pipeline_handling', 'repository_management', 'workspace_operation_handling'],
)
def get_pipelines_for_repository(workspace: str, repo_slug: str = ...):
    """
    List pipelines
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
```
 """,
    tags=[
        'pipeline_handling',
        'pipeline_log_handling',
        'repository_pipeline_configuration_handling',
        'repository_pipeline_variable_handling',
        'pipeline_variable_handling',
    ],
)
def create_pipeline_for_repository(
    workspace: str, repo_slug: str = ..., body: Pipeline = ...
):
    """
    Run a pipeline
    """
...
def get_pipeline_for_repository(
    workspace: str, repo_slug: str = ..., pipeline_uuid: str = ...
):
    """
    Get a pipeline
    """
...
@app.get(
    ...
    tags=['pipeline_handling', 'repository_pipeline_configuration_handling'],
)
def get_pipeline_steps_for_repository(
    workspace: str, repo_slug: str = ..., pipeline_uuid: str = ...
):
    """
...
@app.get(
    ...
    tags=['pipeline_handling', 'pipeline_variable_handling'],
)
def get_pipeline_step_for_repository(
    workspace: str, repo_slug: str = ..., pipeline_uuid: str = ..., step_uuid: str = ...
):
    """
...
This endpoint supports (and encourages!) the use of [HTTP Range requests](https://tools.ietf.org/html/rfc7233) to deal with potentially very large log files. """,
    tags=['pipeline_log_handling', 'pipeline_handling'],
)
def get_pipeline_step_log_for_repository(
    workspace: str, repo_slug: str = ..., pipeline_uuid: str = ..., step_uuid: str = ...
):
    """
...
def get_pipeline_container_log(
    workspace: str,
    repo_slug: str = ...,
    pipeline_uuid: str = ...,
    step_uuid: str = ...,
...
@app.get(
    ...
    tags=['test_report_handling', 'pipeline_handling'],
)
def get_pipeline_test_reports(
    workspace: str, repo_slug: str = ..., pipeline_uuid: str = ..., step_uuid: str = ...
):
    """
...
@app.get(
    ...
    tags=['pipeline_handling', 'test_report_handling', 'pipeline_variable_handling'],
)
def get_pipeline_test_report_test_cases(
    workspace: str, repo_slug: str = ..., pipeline_uuid: str = ..., step_uuid: str = ...
):
    """
...
@app.get(
    ...
    tags=['pipeline_handling', 'test_report_handling'],
)
def get_pipeline_test_report_test_case_reasons(
    workspace: str,
    repo_slug: str = ...,
    pipeline_uuid: str = ...,
    step_uuid: str = ...,
...
def stop_pipeline(workspace: str, repo_slug: str = ..., pipeline_uuid: str = ...):
    """
    Stop a pipeline
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.get(
    ...
    tags=[
        'workspace_operation_handling',
        'repository_management',
        'workspace_permission_handling',
    ],
)
def get_repository_pipeline_config(workspace: str, repo_slug: str = ...):
    """
    Get configuration
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.put(
    ...
    tags=['repository_pipeline_configuration_handling'],
)
def update_repository_pipeline_config(
    workspace: str, repo_slug: str = ..., body: PipelinesConfig = ...
):
    """
...
@app.put(
    ...
    tags=['repository_management', 'pipeline_handling'],
)
def update_repository_build_number(
    workspace: str, repo_slug: str = ..., body: PipelineBuildNumber = ...
):
    """
...
@app.get(
    ...
    tags=['workspace_operation_handling', 'repository_management'],
)
def get_repository_pipeline_schedules(workspace: str, repo_slug: str = ...):
    """
    List schedules
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    tags=['repository_pipeline_scheduling_handling', 'pipeline_handling'],
)
def create_repository_pipeline_schedule(
    workspace: str, repo_slug: str = ..., body: PipelineSchedule = ...
):
    """
    Create a schedule
    """
...
@app.delete(
    ...
    tags=['repository_pipeline_scheduling_handling'],
)
def delete_repository_pipeline_schedule(
    workspace: str, repo_slug: str = ..., schedule_uuid: str = ...
):
    """
    Delete a schedule
    """
...
@app.get(
    ...
    tags=['repository_pipeline_scheduling_handling', 'workspace_operation_handling'],
)
def get_repository_pipeline_schedule(
    workspace: str, repo_slug: str = ..., schedule_uuid: str = ...
):
    """
    Get a schedule
...
def update_repository_pipeline_schedule(
    workspace: str,
    repo_slug: str = ...,
    schedule_uuid: str = ...,
...
@app.get(
    ...
    tags=['workspace_operation_handling', 'repository_pipeline_scheduling_handling'],
)
def get_repository_pipeline_schedule_executions(
    workspace: str, repo_slug: str = ..., schedule_uuid: str = ...
):
    """
...
@app.delete(
    ...
    tags=['repository_pipeline_ssh_handling'],
)
def delete_repository_pipeline_key_pair(workspace: str, repo_slug: str = ...):
    """
    Delete SSH key pair
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.get(
    ...
    tags=['repository_pipeline_ssh_handling', 'user_management'],
)
def get_repository_pipeline_ssh_key_pair(workspace: str, repo_slug: str = ...):
    """
    Get SSH key pair
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def update_repository_pipeline_key_pair(
    workspace: str, repo_slug: str = ..., body: PipelineSshKeyPair = ...
):
    """
    Update SSH key pair
    """
...
@app.get(
    ...
    tags=['repository_pipeline_ssh_handling', 'workspace_operation_handling'],
)
def get_repository_pipeline_known_hosts(workspace: str, repo_slug: str = ...):
    """
    List known hosts
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def create_repository_pipeline_known_host(
    workspace: str, repo_slug: str = ..., body: PipelineKnownHost = ...
):
    """
    Create a known host
    """
...
def delete_repository_pipeline_known_host(
    workspace: str, repo_slug: str = ..., known_host_uuid: str = ...
):
    """
    Delete a known host
    """
...
def get_repository_pipeline_known_host(
    workspace: str, repo_slug: str = ..., known_host_uuid: str = ...
):
    """
    Get a known host
...
def update_repository_pipeline_known_host(
    workspace: str,
    repo_slug: str = ...,
    known_host_uuid: str = ...,
...
def get_repository_pipeline_variables(workspace: str, repo_slug: str = ...):
    """
...
@app.post(
    ...
    tags=['repository_pipeline_variable_handling', 'pipeline_variable_handling'],
)
def create_repository_pipeline_variable(
    workspace: str, repo_slug: str = ..., body: PipelineVariable = ...
):
    """
...
@app.delete(
    ...
    tags=['repository_management', 'repository_variable_handling'],
)
def delete_repository_pipeline_variable(
    workspace: str, repo_slug: str = ..., variable_uuid: str = ...
):
    """
...
@app.get(
    ...
    tags=['repository_management', 'repository_hosted_properties_handling'],
)
def get_repository_pipeline_variable(
    workspace: str, repo_slug: str = ..., variable_uuid: str = ...
):
    """
...
@app.put(
    ...
    tags=[
        'repository_pipeline_variable_handling',
        'pipeline_variable_handling',
        'pipeline_variables_handling',
    ],
)
def update_repository_pipeline_variable(
    workspace: str,
    repo_slug: str = ...,
    variable_uuid: str = ...,
...
@app.delete(
    ...
    tags=[
        'repository_hosted_properties_handling',
        'addon_management',
        'repository_management',
    ],
)
def delete_repository_hosted_property_value(
    workspace: str, repo_slug: str = ..., app_key: str = ..., property_name: str = ...
):
    """
...
@app.get(
    ...
    tags=['repository_hosted_properties_handling', 'repository_management'],
)
def get_repository_hosted_property_value(
    workspace: str, repo_slug: str = ..., app_key: str = ..., property_name: str = ...
):
    """
...
@app.put(
    ...
    tags=['repository_hosted_properties_handling', 'addon_management'],
)
def update_repository_hosted_property_value(
    workspace: str,
    repo_slug: str = ...,
    app_key: str = ...,
    property_name: str = ...,
...
def get_repositories__workspace__repo_slug_pullrequests(
    state: Optional[State4] = None, repo_slug: str = ..., workspace: str = ...
):
    """
    List pull requests
    """
...
def post_repositories__workspace__repo_slug_pullrequests(
    repo_slug: str, workspace: str = ..., body: Pullrequest = None
):
    """
...
``` """,
    tags=[
        'repository_pull_request_handling',
        'pull_request_handling',
        'pull_request_change_listing',
    ],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
...
def get_repositories__workspace__repo_slug_pullrequests_activity(
    repo_slug: str, workspace: str = ...
):
    """
...
def get_pull_request_by_id(
    pull_request_id: int, repo_slug: str = ..., workspace: str = ...
):
    """
    Get a pull request
    """
...
request. """,
    tags=['commit_approval_handling', 'pull_request_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
details. """,
    tags=['pull_request_comment_handling', 'pull_request_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
Returns the newly created pull request comment. """,
    tags=['pull_request_handling', 'pull_request_comment_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
@app.post(
    ...
    tags=['repository_merge_handling', 'pull_request_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def merge_pull_request(
    async_: Optional[bool] = Query(None, alias='async'),
    pull_request_id: int = ...,
    repo_slug: str = ...,
    workspace: str = ...,
    body: PullrequestMergeParameters = None,
):
    """
...
def get_merge_task_status_for_pull_request(
    pull_request_id: int, repo_slug: str = ..., task_id: str = ..., workspace: str = ...
):
    """
...
def remove_pull_request_change_request(
    pull_request_id: int, repo_slug: str = ..., workspace: str = ...
):
    """
...
def request_changes_for_pull_request(
    pull_request_id: int, repo_slug: str = ..., workspace: str = ...
):
    """
...
def list_commit_statuses_for_pull_request(
    q: Optional[str] = None,
    sort: Optional[str] = None,
    pull_request_id: int = ...,
    repo_slug: str = ...,
...
@app.delete(
    ...
    tags=[
        'pull_request_property_handling',
        'addon_management',
        'repository_pull_request_handling',
    ],
)
def delete_pull_request_hosted_property_value(
    workspace: str,
    repo_slug: str = ...,
    pullrequest_id: str = ...,
    app_key: str = ...,
...
@app.get(
    ...
    tags=['pull_request_property_handling', 'repository_pull_request_handling'],
)
def get_pull_request_hosted_property_value(
    workspace: str,
    repo_slug: str = ...,
    pullrequest_id: str = ...,
    app_key: str = ...,
...
def update_pull_request_hosted_property_value(
    workspace: str,
    repo_slug: str = ...,
    pullrequest_id: str = ...,
    app_key: str = ...,
...
Bitbucket will apply natural sorting and interpret numerical values as numbers instead of strings. """,
    tags=['repository_management', 'branch_handling', 'tag_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_refs(
    q: Optional[str] = None,
    sort: Optional[str] = None,
    repo_slug: str = ...,
    workspace: str = ...,
...
",
        ...
        Bitbucket will apply natural sorting and interpret numerical values as numbers instead of strings. """,
    tags=['repository_management', 'branch_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_refs_branches(
    q: Optional[str] = None,
    sort: Optional[str] = None,
    repo_slug: str = ...,
    workspace: str = ...,
...
def post_repositories__workspace__repo_slug_refs_branches(
    repo_slug: str, workspace: str = ...
):
    """
    Create a branch
...
The branch name should not include any prefixes (e.g.
refs/heads). """,
    tags=['branch_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def delete_repositories__workspace__repo_slug_refs_branches__name(
    name: str, repo_slug: str = ..., workspace: str = ...
):
    """
    Delete a branch
    """
...
def get_repositories__workspace__repo_slug_refs_branches__name(
    name: str, repo_slug: str = ..., workspace: str = ...
):
    """
    Get a branch
...
Sorting can be changed using the ?sort= query parameter. When using ?sort=name to explicitly sort on ref name,
Bitbucket will apply natural sorting and interpret numerical values as numbers instead of strings. """,
    tags=['tag_handling', 'workspace_operation_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_refs_tags(
    q: Optional[str] = None,
    sort: Optional[str] = None,
    repo_slug: str = ...,
    workspace: str = ...,
...
ambiguous. Using a full commit hash is the preferred approach. """,
    tags=['tag_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def post_repositories__workspace__repo_slug_refs_tags(
    repo_slug: str, workspace: str = ..., body: Tag = ...
):
    """
    Create a tag
    """
...
def delete_repositories__workspace__repo_slug_refs_tags__name(
    name: str, repo_slug: str = ..., workspace: str = ...
):
    """
    Delete a tag
...
def get_repositories__workspace__repo_slug_refs_tags__name(
    name: str, repo_slug: str = ..., workspace: str = ...
):
    """
    Get a tag
...
def get_repositories__workspace__repo_slug_src(
    format: Optional[Format] = None, repo_slug: str = ..., workspace: str = ...
):
    """
...
def post_repositories__workspace__repo_slug_src(
...
details. """,
    tags=['repository_management', 'repository_component_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_src__commit__path(
...
This resource is only available on repositories that have the issue
tracker enabled. """,
    tags=['repository_management', 'issue_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_versions(
    repo_slug: str, workspace: str = ...
):
    """
...
def get_repositories__workspace__repo_slug_versions__version_id(
    repo_slug: str, version_id: int = ..., workspace: str = ...
):
    """
...
repository. """,
    tags=['repository_management', 'issue_watching_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_repositories__workspace__repo_slug_watchers(
    repo_slug: str, workspace: str = ...
):
    """
...
def get_snippets(role: Optional[Role7] = None):
    """
    List snippets
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def post_snippets(body: Snippet):
    """
    Create a snippet
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
returned. """,
    tags=['workspace_operation_handling', 'snippet_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_snippets__workspace(role: Optional[Role7] = None, workspace: str = ...):
    """
...
def post_snippets__workspace(workspace: str, body: Snippet = ...):
    """
...
def delete_snippets__workspace__encoded_id(encoded_id: str, workspace: str = ...):
    """
    Delete a snippet
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
Response:
    ...
    AqxFUD6OMxcvkO+UfKfkOyXfKdsv/AYCHMLVkHAFWgAAAABJRU5ErkJggg==
    ------------------------------5957323a6b76-- """,
    tags=['snippet_handling', 'workspace_operation_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_snippets__workspace__encoded_id(encoded_id: str, workspace: str = ...):
    """
    Get a snippet
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def put_snippets__workspace__encoded_id(encoded_id: str, workspace: str = ...):
    """
    Update a snippet
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
The default sorting is oldest to newest and can be overridden with
the `sort` query parameter. """,
    tags=['snippet_comment_management', 'snippet_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_snippets__workspace__encoded_id_comments(encoded_id: str, workspace: str = ...):
    """
...
To create a threaded reply to an existing comment, include `parent.id`. """,
    tags=['snippet_handling', 'snippet_comment_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def post_snippets__workspace__encoded_id_comments(
    encoded_id: str, workspace: str = ..., body: SnippetComment = ...
):
    """
...
def delete_snippets__workspace__encoded_id_comments__comment_id(
    comment_id: int, encoded_id: str = ..., workspace: str = ...
):
    """
...
def get_snippets__workspace__encoded_id_comments__comment_id(
    comment_id: int, encoded_id: str = ..., workspace: str = ...
):
    """
...
def put_snippets__workspace__encoded_id_comments__comment_id(
    comment_id: int,
    encoded_id: str = ...,
    workspace: str = ...,
    body: SnippetComment = ...,
...
def get_snippets__workspace__encoded_id_commits(encoded_id: str, workspace: str = ...):
    """
...
def get_snippets__workspace__encoded_id_commits__revision(
    encoded_id: str, revision: str = ..., workspace: str = ...
):
    """
...
out the versioned file links. """,
    tags=['snippet_handling', 'repository_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_snippets__workspace__encoded_id_files__path(
    encoded_id: str, path: str = ..., workspace: str = ...
):
    """
...
to indicate success. """,
    tags=['snippet_handling', 'issue_watching_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def delete_snippets__workspace__encoded_id_watch(encoded_id: str, workspace: str = ...):
    """
...
def get_snippets__workspace__encoded_id_watch(encoded_id: str, workspace: str = ...):
    """
...
def put_snippets__workspace__encoded_id_watch(encoded_id: str, workspace: str = ...):
    """
    Watch a snippet
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.get(
    ...
    tags=['snippet_handling', 'user_management', 'workspace_operation_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_snippets__workspace__encoded_id_watchers(encoded_id: str, workspace: str = ...):
    """
...
def delete_snippets__workspace__encoded_id__node_id(
    encoded_id: str, node_id: str = ..., workspace: str = ...
):
    """
...
def get_snippets__workspace__encoded_id__node_id(
    encoded_id: str, node_id: str = ..., workspace: str = ...
):
    """
...
def put_snippets__workspace__encoded_id__node_id(
    encoded_id: str, node_id: str = ..., workspace: str = ...
):
    """
...
def get_snippets__workspace__encoded_id__node_id_files__path(
    encoded_id: str, node_id: str = ..., path: str = ..., workspace: str = ...
):
    """
...
Bitbucket to reliably determine this. """,
    tags=['repository_diff_handling', 'snippet_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_snippets__workspace__encoded_id__revision_diff(
    path: Optional[str] = None,
    encoded_id: str = ...,
    revision: str = ...,
    workspace: str = ...,
...
def get_snippets__workspace__encoded_id__revision_patch(
    encoded_id: str, revision: str = ..., workspace: str = ...
):
    """
...
This endpoint has been deprecated, and you should use the new workspaces endpoint. For more information, see [the announcement](https://developer.atlassian.com/cloud/bitbucket/bitbucket-api-teams-deprecation/). """,
    tags=['user_management', 'user_application_property_handling'],
)
def get_pipeline_variables_for_team(username: str):
    """
...
This endpoint has been deprecated, and you should use the new workspaces endpoint. For more information, see [the announcement](https://developer.atlassian.com/cloud/bitbucket/bitbucket-api-teams-deprecation/). """,
    tags=['pipeline_variable_handling', 'user_management'],
)
def create_pipeline_variable_for_team(username: str, body: PipelineVariable = None):
    """
...
This endpoint has been deprecated, and you should use the new workspaces endpoint. For more information, see [the announcement](https://developer.atlassian.com/cloud/bitbucket/bitbucket-api-teams-deprecation/). """,
    tags=['pipeline_variable_handling'],
)
def delete_pipeline_variable_for_team(username: str, variable_uuid: str = ...):
    """
...
This endpoint has been deprecated, and you should use the new workspaces endpoint. For more information, see [the announcement](https://developer.atlassian.com/cloud/bitbucket/bitbucket-api-teams-deprecation/). """,
    tags=['user_application_property_handling', 'pipeline_variable_handling'],
)
def get_pipeline_variable_for_team(username: str, variable_uuid: str = ...):
    """
...
This endpoint has been deprecated, and you should use the new workspaces endpoint. For more information, see [the announcement](https://developer.atlassian.com/cloud/bitbucket/bitbucket-api-teams-deprecation/). """,
    tags=['pipeline_variable_handling', 'pipeline_variables_handling'],
)
def update_pipeline_variable_for_team(
    username: str, variable_uuid: str = ..., body: PipelineVariable = ...
):
    """
...
Try `fields=%2Bvalues.*.*.*.*` to get an idea what's possible.
 """,
    tags=['code_search_handling'],
)
def search_team(
    username: str,
    search_query: str = ...,
    page: Optional[int] = 1,
    pagelen: Optional[int] = 10,
):
    """
...
def get_user_emails__email(email: str):
    """
...
def get_user_permissions_repositories(
...
Note that the query parameter values need to be URL escaped so that `=`
would become `%3D`. """,
    tags=['workspace_operation_handling', 'user_management'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_user_permissions_workspaces(
    q: Optional[str] = None, sort: Optional[str] = None
):
    """
...
def get_users__selected_user(selected_user: str):
    """
    Get a user
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def get_pipeline_variables_for_user(selected_user: str):
    """
...
This endpoint has been deprecated, and you should use the new workspaces endpoint. For more information, see [the announcement](https://developer.atlassian.com/cloud/bitbucket/bitbucket-api-teams-deprecation/). """,
    tags=['user_management', 'pipeline_variable_handling'],
)
def create_pipeline_variable_for_user(
    selected_user: str, body: PipelineVariable = None
):
    """
    Create a variable for a user
    """
...
def delete_pipeline_variable_for_user(selected_user: str, variable_uuid: str = ...):
    """
...
def get_pipeline_variable_for_user(selected_user: str, variable_uuid: str = ...):
    """
...
def update_pipeline_variable_for_user(
    selected_user: str, variable_uuid: str = ..., body: PipelineVariable = ...
):
    """
...
@app.delete(
    ...
    tags=['user_application_property_handling'],
)
def delete_user_hosted_property_value(
    selected_user: str, app_key: str = ..., property_name: str = ...
):
    """
...
def retrieve_user_hosted_property_value(
    selected_user: str, app_key: str = ..., property_name: str = ...
):
    """
...
def update_user_hosted_property_value(
    selected_user: str,
    app_key: str = ...,
    property_name: str = ...,
    body: ApplicationProperty = ...,
...
def get_users__selected_user_ssh_keys(selected_user: str):
    """
    List SSH keys
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
``` """,
    tags=['user_management', 'deploy_key_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def post_users__selected_user_ssh_keys(selected_user: str, body: SshAccountKey = None):
    """
    Add a new SSH key
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def delete_users__selected_user_ssh_keys__key_id(key_id: str, selected_user: str = ...):
    """
    Delete a SSH key
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def get_users__selected_user_ssh_keys__key_id(key_id: str, selected_user: str = ...):
    """
    Get a SSH key
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
``` """,
    tags=['user_management', 'repository_pipeline_ssh_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def put_users__selected_user_ssh_keys__key_id(
    key_id: str, selected_user: str = ..., body: SshAccountKey = None
):
    """
    Update a SSH key
    """
...
see the [deprecation announcement](/cloud/bitbucket/deprecation-notice-collaborator-role/).** """,
    tags=[
        'workspace_operation_handling',
        'workspace_member_handling',
        'workspace_permission_handling',
        'workspace_project_handling',
        'workspace_search_handling',
    ],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
...
def get_workspaces(
    role: Optional[Role11] = None, q: Optional[str] = None, sort: Optional[str] = None
):
    """
...
def get_workspaces__workspace(workspace: str):
    """
    Get a workspace
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def get_workspaces__workspace_hooks(workspace: str):
    """
...
Only workspace owners can install webhooks on workspaces. """,
    tags=['workspace_webhook_handling', 'workspace_operation_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def post_workspaces__workspace_hooks(workspace: str):
    """
...
def delete_workspaces__workspace_hooks__uid(uid: str, workspace: str = ...):
    """
...
def get_workspaces__workspace_hooks__uid(uid: str, workspace: str = ...):
    """
...
def put_workspaces__workspace_hooks__uid(uid: str, workspace: str = ...):
    """
...
@app.get(
    ...
    tags=['user_management', 'workspace_member_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_workspaces__workspace_members(workspace: str):
    """
...
def get_workspaces__workspace_members__member(member: str, workspace: str = ...):
    """
...
def get_workspaces__workspace_permissions(
    q: Optional[str] = None, workspace: str = ...
):
    """
...
Note that the query parameter values need to be URL escaped so that `=`
would become `%3D`. """,
    tags=['repository_permission_handling', 'workspace_permission_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_workspaces__workspace_permissions_repositories(
    q: Optional[str] = None, sort: Optional[str] = None, workspace: str = ...
):
    """
...
Note that the query parameter values need to be URL escaped so that `=`
would become `%3D`. """,
    tags=['repository_management', 'workspace_permission_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_workspaces__workspace_permissions_repositories__repo_slug(
    q: Optional[str] = None,
    sort: Optional[str] = None,
    repo_slug: str = ...,
    workspace: str = ...,
...
def get_o_i_d_c_configuration(workspace: str):
    """
...
@app.get(
    ...
    description=""" This is part of OpenID Connect for Pipelines, see https://support.atlassian.com/bitbucket-cloud/docs/integrate-pipelines-with-resource-servers-using-oidc/ """,
    tags=['pipeline_handling', 'workspace_operation_handling'],
)
def get_o_i_d_c_keys(workspace: str):
    """
...
def get_pipeline_variables_for_workspace(workspace: str):
    """
...
@app.post(
    ...
    tags=['pipeline_variable_handling', 'workspace_operation_handling'],
)
def create_pipeline_variable_for_workspace(
    workspace: str, body: PipelineVariable = None
):
    """
...
@app.delete(
    ...
    tags=['workspace_operation_handling'],
)
def delete_pipeline_variable_for_workspace(workspace: str, variable_uuid: str = ...):
    """
...
def get_pipeline_variable_for_workspace(workspace: str, variable_uuid: str = ...):
    """
...
def update_pipeline_variable_for_workspace(
    workspace: str, variable_uuid: str = ..., body: PipelineVariable = ...
):
    """
...
@app.get(
    ...
    tags=['workspace_operation_handling', 'workspace_project_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_workspaces__workspace_projects(workspace: str):
    """
...
``` """,
    tags=['workspace_project_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def post_workspaces__workspace_projects(workspace: str, body: Project = ...):
    """
...
def delete_workspaces__workspace_projects__project_key(
    project_key: str, workspace: str = ...
):
    """
...
@app.get(
    ...
    tags=['workspace_project_handling', 'workspace_operation_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_workspaces__workspace_projects__project_key(
    project_key: str, workspace: str = ...
):
    """
...
def put_workspaces__workspace_projects__project_key(
    project_key: str, workspace: str = ..., body: Project = ...
):
    """
...
``` """,
    tags=['project_branching_model_handling', 'repository_branching_model_fetching'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def get_workspaces__workspace_projects__project_key_branching_model(
    project_key: str, workspace: str = ...
):
    """
...
def get_branching_model_config_for_project(project_key: str, workspace: str = ...):
    """
...
``` """,
    tags=['project_branching_model_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def update_branching_model_config_for_project(project_key: str, workspace: str = ...):
    """
...
``` """,
    tags=['default_reviewer_management', 'workspace_project_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def list_default_reviewers_in_project(project_key: str, workspace: str = ...):
    """
...
def remove_user_from_default_reviewers(
    project_key: str, selected_user: str = ..., workspace: str = ...
):
    """
...
def get_default_reviewer_for_project(
    project_key: str, selected_user: str = ..., workspace: str = ...
):
    """
    Get a default reviewer
...
def add_default_reviewer_to_project(
    project_key: str, selected_user: str = ..., workspace: str = ...
):
    """
...
def get_workspaces__workspace_projects__project_key_deploy_keys(
    project_key: str, workspace: str = ...
):
    """
...
``` """,
    tags=['project_deploy_key_handling', 'deploy_key_handling'],
    security=[
        UnsuportedSecurityStub(name="None"),
        HTTPBasic(name="None"),
        APIKeyHeader(name="Authorization"),
...
def post_workspaces__workspace_projects__project_key_deploy_keys(
    project_key: str, workspace: str = ...
):
    """
...
def delete_deploy_key_from_project(
    key_id: str, project_key: str = ..., workspace: str = ...
):
    """
...
def get_project_deploy_key(key_id: str, project_key: str = ..., workspace: str = ...):
    """
